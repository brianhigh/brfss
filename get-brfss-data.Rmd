...
Get the 2012-2018 datasets from http://www.cdc.gov/brfss, load into a data 
...
```{r}
datayears <- as.character(seq(2012, 2018))
```
...
# Note: To save as an Rdata file: saveRDS(brfss, "data/brfss_data.rds")
