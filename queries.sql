...
SELECT 
    IYEAR AS Year, COUNT(*) AS Respondents
FROM
    brfss
WHERE
    X_STATE = 53
...
SELECT 
    X_EDUCAG AS Education, COUNT(*) AS Respondents
FROM
    brfss
WHERE
    IYEAR = 2014 AND X_STATE = 53
GROUP BY X_EDUCAG
ORDER BY X_EDUCAG;

SELECT 
    X_EDUCAG AS Education, COUNT(USENOW3) AS Smokers
FROM
    brfss
WHERE
    IYEAR = 2014 AND X_STATE = 53
